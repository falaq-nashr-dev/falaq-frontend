...
const BottomNavigation = () => {
  ...
  return (
    <div className=" max-w-xl left-1/2 -translate-x-1/2 h-[80px] navigation-shadow fixed bottom-0 w-full  bg-white rounded-t-[24px] flex items-center justify-between px-5 pb-1">
      <div
